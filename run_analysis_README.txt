*** Read Me for Getting and Cleaning Data Coursera Week 4 Assignment
   ...
   2. Read the data files
      (For all files, use read.table("file location and name"), ex. subjtest <- read.table("UCI HAR Dataset/test/subject_test.txt") )
		...
		c. read the subject_test file as subjtest  (this file contains a record for subjects equal to the number of records in the x_test file.  
		                                We will append this file as a new column, Subject, to the x_test file.)
		...
		e. read the y_test file as ytest (this file contains a record for activities equal to the number of records in the x_test file.
								 We will append this file as a new column, Activity), to the x_test file.)
			i. determine the min and max values in this file to make sure they fall between 1 and 6.
		f. read the subject_train file as subjtrain (this file contains a record for subjects equal to the number of records in the x_train file.  
		                                We will append this file as a new column, Subject, to the x_train file.)
		...
		h. read the y_train file as ytrain  (this file contains a record for activities equal to the number of records in the x_train file.
								 We will append this file as a new column, Activity), to the x_train file.)
			i. determine the min and max values in this file to make sure they fall between 1 and 6.
